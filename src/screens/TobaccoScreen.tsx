...
const TobaccoScreen: React.FC<TobaccoScreenProps> = ({ onNext, onBack }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <View style={styles.mainContent}>
                    ...
                    <FadeUpView delay={300}>
                        <Text style={styles.subtitle}>Do you smoke?</Text>
                    </FadeUpView>
                    ...
                    <FadeUpView delay={450} style={styles.optionsList}>
                        {options.map((opt) => (
                            <PremiumOptionRow
                                key={opt.id}
                                label={opt.label}
                                selected={tobacco === opt.id}
                                onPress={() => setTobacco(opt.id)}
                            />
                        ))}
                    </FadeUpView>
                </View>
            ...
            >
                <TouchableOpacity
                    style={[styles.btnContinue, !tobacco && styles.btnDisabled]}
                    onPress={handleNext}
                    activeOpacity={0.8}
                    disabled={!tobacco}
                >
